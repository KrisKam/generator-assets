module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c12 = [],
        peg$c13 = null,
        peg$c14 = function(size, canvassize, folders, suffix) { return size || folders.length > 0 || (suffix && suffix.trim().length > 0)},
        peg$c15 = void 0,
        peg$c16 = function(size, canvassize, folders, suffix) { // require at least one spec
                var result = {
                    "default": true,
                    name: text().trim()
                };
        ...
        peg$c27 = function(size, canvassize, folders, filepart) { // Parsed layer name part
                var result = {
                    name: text().trim(),
        ...
        peg$c57 = { type: "other", description: "Component canvas size, either long or short form" },
        peg$c58 = { type: "other", description: "Long form component canvas size, like [32x64]" },
        peg$c59 = "[",
        ...
        peg$c64 = { type: "other", description: "short form component canvas size, like [32]" },
    ...
    function peg$parsecompcanvassize() {
      var s0, s1;

      peg$silentFails++;
      s0 = peg$parselongcanvassize();
      if (s0 === peg$FAILED) {
        s0 = peg$parseshortcanvassize();
      }
      peg$silentFails--;
      if (s0 === peg$FAILED) {
        s1 = peg$FAILED;
    ...
    function peg$parselongcanvassize() {
      var s0, s1, s2, s3, s4, s5;
    ...
    function peg$parseshortcanvassize() {
      var s0, s1, s2, s3;
